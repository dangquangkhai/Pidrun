                        ...
                        <div class="col-md-12">
                            ...
                            <div class="message me">
                                <div class="text-main">
                                    ...
                                    <span>
                                        <i class="material-icons">check</i>10:21 PM
                                    </span>
                                </div>
                            </div>
                            <div class="message">
                            ...
                            <div class="inside">
                                <div class="panel">
                                    <div class="participant">
                                        <img class="avatar-xxl" src="swipe/img/avatars/avatar-female-5.jpg" alt="avatar" />
                    ...
                    <div class="container">
                        <div class="col-md-12">
                            <div class="inside">
                                <div class="panel">
                                    <div class="participant">
                                        <img class="avatar-xxl" src="swipe/img/avatars/avatar-female-2.jpg" alt="avatar" />
                                        <span>Connecting</span>
                                    </div>
                                    <div class="options">
                                        <button class="btn option">
                    ...
                    <div class="container">
                        <div class="col-md-12">
                            <div class="no-messages request">
                                <a href="#">
                                    <img class="avatar-xl" src="swipe/img/avatars/avatar-female-6.jpg" data-toggle="tooltip" data-placement="top" title="Louis" alt="avatar" />
                                </a>
                                <h5>
                                    Louis Martinez would like to add you as a contact.
                                    <span>Hi Keith, I'd like to add you as a contact.</span>
                                </h5>
                                <div class="options">
                    ...
                    <div class="col-md-12">
                        <div class="bottom">
                            ...
                            <label>
                                ...
                                <span class="btn attach disabled d-sm-block d-none">
                                    <i class="material-icons">attach_file</i>
                                </span>
                            </label>
                        </div>
...
export default {
    ...
    methods: {
        getMess(conid, messid = null) {
            this.$http.post(this.CON_CONTROLLER + "/getmess", {
                conId: conid,
                messId: messid
            }).then(res => {
                this.conMess = res.data.content;
            })
        }
    },
};
